...
class SlotAthleteGroupActivationForm extends Component<Props, {}> {
  render() {
    const { slotId, mutation, query } = this.props;
    ...
    return (
      <AttributesInlineForm
            ...
            variables: {
              ...
              data: {
                activeDiscipline: data.activeDiscipline
                  ...
                  : null,
                activeAthleteGroupId: data.activeAthleteGroupId
                  ? data.activeAthleteGroupId
                  : null
              }
            }
          });
        ...
        values={{
          activeDiscipline: slot.activeDiscipline
            ? slot.activeDiscipline
            : undefined,
          activeAthleteGroupId: slot.activeAthleteGroupId
