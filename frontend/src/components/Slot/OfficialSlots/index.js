...
import OfficialSlotsTable from '../../Official/SlotsTable';
import waitWhileLoading from '../../../hoc/waitWhileLoading';
import Toolbar from '../../Toolbar';
import Bold from '../../Bold';
import OfficialSlotCreateForm from '../../Official/SlotCreateForm';
import Strings from '../../../constants/strings';

const OfficialSlotsQuery = loader(
  '../../../graphql/queries/slotOfficialSlots.graphql'
);
const RemoveOfficialSlotMutation = loader(
  '../../../graphql/mutations/deleteOfficialSlot.graphql'
);
      ...
      .then(() =>
        Promise.all(
          this.state.selectedRowKeys.map(id =>
            this.props.removeOfficialSlotMutation({
              variables: {
                id
              }
            })
      ...
      <div>
          ...
          renderRight={() => [
            this.state.selectedRowKeys.length ? (
              <Button
                ...
                key={'delete'}
                type={'danger'}
                onClick={this._handleRemoveSelected}
                icon={'minus'}>
                Entfernen
              </Button>
            ) : null,
        ...
        <Modal
          ...
          <OfficialSlotCreateForm
            onCreate={() => this.setState({ showModal: false })}
            eventId={eventId}
            slotId={slotId}
          />
        </Modal>
