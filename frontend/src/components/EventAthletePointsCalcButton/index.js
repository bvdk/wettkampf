...
class EventAthletePointsCalcButton extends Component<Props, State> {
    ...
    handleClick = () => this.setLoading(true)
    ...
    setLoading = (loading) => new Promise((resolve) => this.setState({loading}, resolve));
    ...
    render() {
        ...
        return <div>
            <Button.Group>
                <Button onClick={this.handleClick} loading={loading} icon={'reload'}>Aktualisieren</Button>
