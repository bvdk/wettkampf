...
const AthleteGroupAthletesQuery = loader("../../graphql/queries/eventAthletesUnsorted.graphql");
...
class EventAthletesUnsortedTable extends Component<Props> {
  ...
  render() {
      ...
      const athletes = _.get(eventAthletesUnsortedQuery, 'event.unsortedAthletes', [])
