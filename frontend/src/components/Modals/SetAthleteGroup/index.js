...
import AthleteGroupTable from '../../AthleteGroup/Table';
  ...
  render() {
    ...
    return (
      <Modal
        ...
        width={750}>
        <Infobox>
          <Bold>{athleteIds.length}</Bold> Athleten werden <Bold>einer</Bold>{' '}
          Startgruppe zugeorndet werden. Bitte wählen Sie die entsprechnde
          Startgruppe aus.
        </Infobox>
        <AthleteGroupTable
