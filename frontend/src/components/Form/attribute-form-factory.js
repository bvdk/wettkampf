                        ...
                        <Dropdown {...config} overlay={
                            config && config.loaderConfig ? (
                                ...
                                {attribute.optionValues.map((item, index) => (
                                    <Menu.Item key={item.value}><Checkbox className={"p-0 m-0"}
                                                                          value={item.value}>{item.name}</Checkbox></Menu.Item>))}
                            </Menu>}
                        ...
                        <Radio.Group>
                            {attribute.optionValues.map((item, index) => (
                                <Radio key={`${index}`} style={radioStyle}
                                       value={attributeTypeValue(attribute.type, item.value)}>{item.name}</Radio>
                            ))}
                        </Radio.Group>
                    )
                } else {
