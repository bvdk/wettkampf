...
class AttemptsTable extends Component<Props, State> {
                    ...
                    acc.push({
                        ...
                        render: (text, record) => {
                            ...
                            if (this.props.editableAttemptCols) {
                                return <AttemptInlineForm attempt={attempt} onChange={this.props.onChange}
                                                          athlete={record} discipline={key}
    ...
    render() {
        const {athletes, availableDisciplines, tableProps, filterParams, highlightFirstAthlete} = this.props;
        ...
        const menu = <div style={{padding: '6px 0'}}>
            {
                _.chain(columns)
                    ...
                    return <div style={{margin: '6px 8px'}} key={item.value}><Checkbox
                        checked={!(this.props.hiddenCols.indexOf(item.value) > -1)} onChange={(e) => {
