...
class AthleteImport extends Component<{}, State> {
    state = {
        defaultValues: {}
    };
                ...
                <Row gutter={32}>
                    ...
                    <Col md={8}>
                        <Panel
                            title={"Einstellungen"}
                            bordered={true}>
                            <p>Folgende Einstellungen können als Standardwerte für den Athleten-Import festgelegt
                                werden.</p>
