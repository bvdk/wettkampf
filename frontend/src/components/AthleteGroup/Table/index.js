...
const DeleteAthleteGroupMutation = loader(
  '../../../graphql/mutations/deleteAthleteGroup.graphql'
);
const SetAthleteGroupSlotMutation = loader(
  '../../../graphql/mutations/setAthleteGroupSlot.graphql'
);
...
class AthleteGroupTable extends Component<Props, {}> {
  static defaultProps = {
    hideKeys: []
  };
