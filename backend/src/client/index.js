...
class EventClient {
  ...
  athletes(args) {
    ...
    const dataPath = [...this._dataPath, prefix, 'athletes']
  ...
  slots(args) {
    const prefix = this._dataPath.includes('select') ? 'select' : this._dataPath.includes('include') ? 'include' : 'select'
    const dataPath = [...this._dataPath, prefix, 'slots']
    const newArgs = deepSet(this._args, dataPath, args || true)
    this._isList = true
  ...
  athleteGroups(args) {
    const prefix = this._dataPath.includes('select') ? 'select' : this._dataPath.includes('include') ? 'include' : 'select'
    const dataPath = [...this._dataPath, prefix, 'athleteGroups']
    const newArgs = deepSet(this._args, dataPath, args || true)
    this._isList = true
  ...
  officials(args) {
    const prefix = this._dataPath.includes('select') ? 'select' : this._dataPath.includes('include') ? 'include' : 'select'
    const dataPath = [...this._dataPath, prefix, 'officials']
    const newArgs = deepSet(this._args, dataPath, args || true)
    this._isList = true
...
class AthleteClient {
  ...
  attempts(args) {
    const prefix = this._dataPath.includes('select') ? 'select' : this._dataPath.includes('include') ? 'include' : 'select'
    const dataPath = [...this._dataPath, prefix, 'attempts']
    const newArgs = deepSet(this._args, dataPath, args || true)
    this._isList = true
...
class SlotClient {
  ...
  officialSlots(args) {
    const prefix = this._dataPath.includes('select') ? 'select' : this._dataPath.includes('include') ? 'include' : 'select'
    const dataPath = [...this._dataPath, prefix, 'officialSlots']
    const newArgs = deepSet(this._args, dataPath, args || true)
    this._isList = true
