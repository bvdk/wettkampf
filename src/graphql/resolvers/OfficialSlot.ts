...
export default class OfficialSlotResolver implements ResolverInterface<OfficialSlot> {
    ...
    public official(@Root() officialSlot: OfficialSlot) {
        ...
        return CrudAdapter.getItem(CollectionKeys.officials, officialSlot.officialId);
    }
