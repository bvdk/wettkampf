...
export default class OfficialSlotsResolver {
    ...
    @Query((returns) => OfficialSlot, {nullable: true, description: "Get a OfficialSlot" })
    public officialSlot(
        @Args() {id}: IdArgs,
    ): OfficialSlot {
    ...
    @Mutation()
    public createOfficialSlot(
        @Args() {input, officialId, slotId}: CreateOfficialSlotArgs,
    ): OfficialSlot {
