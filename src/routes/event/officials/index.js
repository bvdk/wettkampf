...
class EventOfficialsRoute extends Component<Props, State> {
  ...
  render() {
    ...
    return <Switch>
      <Route path={"/events/:eventId/officials/new"} component={ (props) => <EventOfficialCreateRoute history={props.history} eventId={eventId} />}/>
      <Route path={"/events/:eventId/officials/:officialId"} component={ (props) => <OfficialDashboardRoute history={props.history} eventId={eventId} />}/>
